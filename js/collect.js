function collect () {
    ...
    function makeForm(XMLdata,gitName,gitPath,gitSHA) {
        ...
        fieldset.innerHTML = `<legend>Texte zur Aufführung</legend>`;
        container = fieldset.querySelector(".form-container");
        ...
        fieldset.innerHTML = `<legend>Texte zur Handlung</legend>`;
        container = fieldset.querySelector(".form-container");
        ...
        fieldset.innerHTML = `<legend>Texte zur Musik</legend>`;
        container = fieldset.querySelector(".form-container");
        ...
        fieldset = document.createElement("fieldset");
        fieldset.setAttribute("id", "stagingRelated");
        fieldset.innerHTML = `<legend>Historische Texte</legend>`;
        container = fieldset.querySelector(".form-container");
